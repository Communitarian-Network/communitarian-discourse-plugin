  ...
  reloadable_patch do
    ...
    Topic.class_eval do
      ...
      before_save do
        ...
        if title_changed?
          write_attribute(:fancy_title, Topic.fancy_title(title, category, self.try(:is_resolution)))
        end
      ...
      def fancy_title
        ...
        unless fancy_title = read_attribute(:fancy_title)
          fancy_title = Topic.fancy_title(title, category, self.try(:is_resolution))
